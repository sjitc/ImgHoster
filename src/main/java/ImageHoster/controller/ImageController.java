...
public class ImageController {
    ...
    public String showImage(@PathVariable("title") String title, Model model, @PathVariable int imageId) {

        // commented because of uniqueness, fetching an Image with Title may not return a Unique Image object
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model,HttpSession session) {
        ...
        //Getting Logged in UserID from Session//
        User user = (User) session.getAttribute("loggeduser");
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam("tags") String tags, Image updatedImage, HttpSession session) throws IOException {
        ...
        //Invoke updateImage method and pass Logged in User's id//
        //Inorder to check logged in User and owner of the Image are same or not//
